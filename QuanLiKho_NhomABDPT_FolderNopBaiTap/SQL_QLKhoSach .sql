...
go
insert into DanhMuc
Values('DM01',N'Sách Lập Trình'),
	  ('DM02',N'Sách Nâng Cao'),
	  ('DM03',N'Sách Toán'),
	  ('DM04',N'Sách Chính Trị')
go
...
go
insert into SanPham
Values ('S01',N'Lập trình Java 2','DM01',N'Đỗ Phú',N'Kim Đồng','24/8/2013','src\img\S01.jpg','50000'),
	   ('S02',N'Lập trình C','DM02',N'Hoàng Thị Mỹ Lệ','SPKT','2/8/2014','src\img\S02.jpg','90000'),
	   ('S03',N'Toán rời rạc','DM03',N'Không biết','HCM','24/8/2013','src\img\S03.jpg','100000'),
	   ('S04',N'Kinh Tế Chính Trị','DM04',N'Trần Quân','HCM','8/8/2012','src\img\S04.jpg','60000'),
	   ('S05',N'Lịch Sử Đảng','DM04',N'Đình Nhân',N'Hà Nội','24/1/2003','src\img\S05.jpg','400000'),
	   ('S06',N'Triết','DM04',N'Quý Bùi',N'Đông Tiến','4/5/2019','src\img\S06.jpg','500000'),
	   ('S07',N'Lập trình trực quan','DM01',N'Lê Vũ','SPKT','2/10/2018','src\img\S07.jpg','550000'),
	   ('S08',N'Cơ sở dữ liệu 2','DM02',N'Nguyễn Hà Quyên','SPKT','11/1/2011','src\img\S08.jpg','200000'),
	   ('S09',N'Giải tích','DM04',N'Không biết','Hà Nội','24/8/2020','src\img\S09.jpg','400000')
go
create table HoaDon(
...
create procedure [dbo].[insertSanPham_pr](@tensach nvarchar(20),@maDm varchar(8),@tacGia nvarchar(30),@NXB nvarchar(30), @ngayxuatbang varchar(12),@src text)
as
begin 
	...
	set @temp = (select top 1 CAST(substring(MaSach,2,9) as int) as ma from SanPham order by ma desc )
	set @temp = @temp+1
	...
	insert into SanPham (MaSach,TenSach,MaDM,Tacgia,NXB,ngayXuatBang,src) 
	values(@temp,@tensach,@maDm,@tacGia,@NXB,@ngayxuatbang,@src)
end
go
drop procedure insertSanPham_pr
